                    ...
                    <>
                        ...
                        <div className="col-3 px-2 d-none d-lg-block">
                            <article className="bg-white rounded shadow">
                                ...
                                <div className="h6 p-2 text-center m-0">
                                    <Link to="#" className="bg-orange d-block w-100 p-3 rounded text-light text-decoration-none custom-btn-shadow">CHECKOUT (&#x20A6;{totalAmount})</Link>
                                </div>
                            </article>
                        </div>
                    </>
