...
const ProductGallery = ({title}) => {
  return (
    <div className="bg-danger">
        ...
        <div className="d-flex flex-column gap-2 bg-info p-2 m-0">
            <div className="d-flex gap-2">
                <div className="p-0 position-relative">
                    <img src={img1} alt="" className="rounded-1 h-100 object-fit-cover" />
                    <span className="position-absolute bottom-0 start-0 z-1 bg-dark bg-opacity-75 text-light text-center w-100 rounded-bottom-1">Deals</span>
                </div>
                <div className="p-0 position-relative">
