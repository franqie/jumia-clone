...
const Text = () => {
  ...
  return (
    <>
        <div className={`rdd text ${hideText ? "hide" : null} bg-white p-3`}>
            <h1 className="h5">Jumia: Online Shopping in Nigeria - No. 1 Shopping Destination</h1>
            ...
            <h1 className="h5 fw-normal">Buy Mobile Phones, Fashion, Electronics, Appliances & more on Jumia</h1>
        ...
        {width < 769 && <div className="p-2 bg-white text-center">
            <button onClick={()=>setHideText(!hideText)} className="hide-btn py-1 bg-white border-0 outline-0">{hideText ? "SHOW MORE" : "SHOW LESS"}</button>
        </div>}
    </>
  )
}
