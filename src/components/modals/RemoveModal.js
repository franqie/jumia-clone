...
const RemoveModal = () => {
  ...
  return (
    <div className={`custom_modal opacity-0 pe-none ${ showRemoveModal && "opacity-100 bg-opacity-50 pe-auto" } bg-normaltext position-fixed top-0 start-0 bottom-0 end-0 d-flex justify-content-center align-items-center`} onClick={()=>setShowRemoveModal(false)}>
